...
class StoryCell: UITableViewCell {
    ...
    private func setupCollectionView() {
        let nib = UINib(nibName: StoryViewCell.identifier, bundle: nil)
        mediaCollectionCell.register(nib, forCellWithReuseIdentifier: StoryViewCell.identifier)
...
extension StoryCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.configDiscoverCell(model: model)
        return cell
    }
